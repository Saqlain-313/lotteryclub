  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col min-h-[160px] justify-between">
        ...
        <button className="bg-white/20 backdrop-blur-sm hover:bg-white/30 transition-colors text-white font-bold py-3 px-6 rounded-xl border border-white/30 mt-3 self-start text-sm">
          {button}
        </button>
      </div>
