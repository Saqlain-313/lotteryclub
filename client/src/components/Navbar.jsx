    ...
    <>
      ...
      <div className="hidden md:flex md:flex-col md:w-72 md:fixed md:inset-y-0 md:bg-white/95 md:backdrop-blur-xl md:z-50 shadow-2xl shadow-gray-200/50 border-r border-white/40 perspective-1000">
        <div className="flex flex-col h-full transform-gpu rotate-y-0 hover:rotate-y-2 transition-all duration-700 ease-out [transform-style:preserve-3d]">
          ...
          {/* Tagline - PLAY • WIN • REPEAT - Clean version without gradient */}
              ...
              {isAuthenticated ? (
                <div className="relative" ref={userMenuRef}>
                  <button
                    ...
                    className="flex items-center gap-3 px-4 py-2 rounded-2xl bg-gradient-to-r from-yellow-400 via-orange-400 to-orange-500 text-black hover:shadow-2xl hover:shadow-yellow-500/35 transition-all duration-500 transform-gpu hover:scale-105 hover:-translate-y-1 hover:rotate-y-3 [transform-style:preserve-3d]"
                  >
                    <div
                  ...
                  {isUserMenuOpen && (
                    <div className="absolute right-0 mt-3 w-72 bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/40 py-2 z-50 animate-slideDown transform-gpu [transform-style:preserve-3d]">
                      <div className="px-4 py-4 border-b border-white/40 transform-gpu hover:translate-z-6 transition-all duration-500">
                        <div className="flex items-center gap-3">
                          <div
                            className={`w-12 h-12 rounded-full bg-gradient-to-r ${getAvatarGradient()} flex items-center justify-center text-white font-bold text-lg shadow-lg transform-gpu hover:scale-110 hover:rotate-y-6 transition-all duration-500 [transform-style:preserve-3d]`}
                          >
                            {getInitial()}
                          </div>
                          <div>
                      ...
                      <div className="border-t border-white/40 pt-1">
                        <button
                          onClick={handleLogout}
                          disabled={loading}
                          className="flex items-center gap-3 px-4 py-3 text-sm text-red-600 hover:bg-gradient-to-r hover:from-red-50/60 hover:to-red-50/30 transition-all duration-300 w-full transform-gpu hover:scale-105 [transform-style:preserve-3d]"
                        >
                          <LogOut size={16} />
                ...
                <div className="hidden sm:flex items-center gap-3">
                  <Link
                    to="/login"
                    className="flex items-center gap-2 px-5 py-2.5 rounded-2xl border-2 border-gray-200 text-sm font-bold text-gray-700 hover:border-yellow-400 hover:text-yellow-500 hover:shadow-xl transition-all duration-500 transform-gpu hover:scale-105 hover:-translate-y-1 hover:rotate-y-3 [transform-style:preserve-3d]"
                  >
                    <LogIn size={18} />
                    Login
                  </Link>
                    ...
                    <div className="px-2 py-2 space-y-1.5">
                      {accountMenuItems.map((item, index) => (
                        <Link
                          ...
                          to={item.path}
                          onClick={() => setIsSidebarOpen(false)}
                          className="flex items-center gap-3 rounded-xl px-4 py-3 text-sm text-gray-600 hover:text-gray-900 hover:bg-gradient-to-r hover:from-yellow-50/60 hover:to-orange-50/60 transition-all duration-300 transform-gpu hover:translate-x-2 [transform-style:preserve-3d]"
                        >
