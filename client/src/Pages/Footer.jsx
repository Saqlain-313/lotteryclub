...
const Footer = () => {
  ...
  return (
    <footer className="bg-surface border-t border-white/40 px-4 md:px-6 py-10 md:py-16">
      <div className="max-w-8xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 mb-8 md:mb-12">
          ...
          <div className="col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <a
                ...
                className="w-8 h-8 md:w-10 md:h-10 bg-white/60 backdrop-blur-sm border border-white/40 rounded-full flex items-center justify-center hover:bg-yellow-400 hover:text-white hover:border-yellow-400 transition-all duration-300 shadow-sm group"
              >
                <Headphones size={16} className="text-gray-600 group-hover:text-white transition-colors" />
              </a>
              <a
                href="#"
                className="w-8 h-8 md:w-10 md:h-10 bg-white/60 backdrop-blur-sm border border-white/40 rounded-full flex items-center justify-center hover:bg-yellow-400 hover:text-white hover:border-yellow-400 transition-all duration-300 shadow-sm group"
          ...
          {/* Quick Links */}
          <div>
            <h5 className="font-black text-sm md:text-base mb-4 md:mb-6 uppercase tracking-wider" style={goldenTextStyle}>
              Quick Links
            </h5>
            <ul className="space-y-2.5 md:space-y-3.5 text-xs md:text-sm">
              <li>
                <a href="#" className="text-gray-500 hover:text-yellow-600 transition-colors duration-200 flex items-center gap-1 group">
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              <button className="absolute right-1.5 top-1/2 -translate-y-1/2 bg-gradient-to-r from-yellow-400 to-yellow-500 text-white p-1.5 md:p-2 rounded-lg hover:scale-105 transition-transform shadow-md">
        ...
        <div className="pt-6 md:pt-8 border-t border-gray-200/50 flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] text-gray-400 font-medium">Licensed</span>
            </div>
