...
export default function ProfilePage() {
    ...
    const getAvatar = () => {
        ...
        return user?.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(name)}&background=amber&color=fff&size=128`;
    };
        ...
        <div className="h-screen bg-slate-100 overflow-hidden">
            ...
            <div className="h-full flex gap-0">
                ...
                <div className="flex-1 h-full overflow-auto p-6">
                    <div className="bg-white rounded-3xl border border-gray-200 shadow-lg p-6 min-h-full">
...
function DesktopSidebar({
    ...
    return (
        <div className="h-full bg-white shadow-lg border-r border-gray-200 overflow-y-auto flex flex-col">
            <div className="p-6 flex-shrink-0">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="font-bold text-xl text-gray-900">{getUserDisplayName()}</h2>
                ...
                {menu.map((item) => {
                    ...
                    return (
                        <button
                            ...
                            className={`w-full rounded-xl px-5 py-4 flex items-center gap-3 font-semibold transition ${activeTab === item.id
...
function MobileSidebar({
    ...
    return (
        ...
        >
            ...
            <div
                className={`absolute left-0 top-0 h-full w-80 bg-white transition-transform duration-300 shadow-2xl ${isOpen ? "translate-x-0" : "-translate-x-full"
                    }`}
            >
                    ...
                    {menu.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={`w-full rounded-xl px-5 py-4 flex items-center gap-3 transition ${activeTab === item.id
                                        ? "bg-amber-100 border border-amber-300 text-amber-700"
                                        : "hover:bg-gray-100 text-gray-700"
                                    }`}
                            >
